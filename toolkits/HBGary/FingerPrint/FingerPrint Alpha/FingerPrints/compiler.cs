    ...
    class compiler : BaseFingerPrint
    {
        ...
        override public bool OnEvaluateString(string theString, ScanResultCollection results)
        {
            ...
            if (aMatch.Success)
            {
                ...
                if (results.ResultExists("Source Path", file_path))
                {
                    results.AddResult("Source Path", file_path, 1, 0);
                }
            }
            ...
            if (aMatch.Success)
            {
                ...
                results.AddResult("Original Project Name", file_name, 1, 0);

                string file_path = Path.GetDirectoryName(matchstring);
                results.AddResult("Original Source Path", file_path, 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                results.AddResult("Delpi", "yes", 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                ...
                results.AddResult("Assembly Description", description, 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                ...
                results.AddResult("Assembly Info", assembly_name, 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                ...
                results.AddResult("Dependent Manifest", dep, 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                ...
                results.AddResult("MFC", mfc_version, 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                results.SetResult("Compiler", "Microsoft Visual C++ 4.2", 1, 0);
            }
            ...
            if (aMatch.Success)
            {
                ...
                if (visual_c_version == "")
                {
                    ...
                    results.SetResult("Compiler", visual_c_version, 1, 0);
                }
            }
